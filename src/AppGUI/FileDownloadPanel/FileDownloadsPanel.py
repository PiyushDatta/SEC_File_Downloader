...
from src.AppGUI.PopUpWindow import DownloadFileTypeDetailsGUI
from src.AppGUI.FileDownloadPanel.FileDownloadsPanelController import DownloadPanelController
