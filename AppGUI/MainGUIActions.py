from AppGUI.TopLayerPanel import TopPanelController

from Observers.DirectoryObserver import CurrentDirectoryObserver
from Observers.CompanyObserver import CurrentCompanyObserver


class MainGUIActions:

    def __init__(self, current_directory, current_company, top_panel_controller, main_menu_controller):
        # Set up controllers
    ...
    def set_observer_targets(self):
        controllers_with_curr_dir = [self._top_panel_controller, self._main_menu_controller]
        controllers_with_curr_comp = [self._top_panel_controller, self._main_menu_controller]
